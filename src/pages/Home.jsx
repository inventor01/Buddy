    ...
    async (user, existing) => {
      ...
      try {
        ...
        const b = await createNoteAndRun({
          ...
          linkedBuddyIds: Array.isArray(l.linkedBuddyIds) ? l.linkedBuddyIds : [],
          executionMode: l.executionMode === "chain" ? "chain" : "single",
          taskSteps: Array.isArray(l.taskSteps) ? l.taskSteps : [],
          image: pending.image,
          name: l.name,
          creature: l.creature,
          when: l.when,
