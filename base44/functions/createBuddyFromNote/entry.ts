  ...
  try {
    ...
    const plan = await base44.asServiceRole.integrations.Core.InvokeLLM({
      ...
      prompt: [
        ...
        'Broad discovery is a valid instruction. If the user asks to find/scan arbitrage, resale, deals, or profit opportunities without narrowing to a category, do NOT ask them to choose a product category, store, marketplace, or specific items. Scan broadly, rank the strongest verifiable opportunities, and let them narrow it later if they want.',
        'For retail arbitrage requests, preserve every named retailer and resale marketplace. If none are named, use broad current U.S. retail/online sourcing and Amazon/eBay resale evidence by default instead of asking another question. Always look for current sale/clearance pricing plus EXTRA item-level digital coupons, loyalty/member offers, public promo codes, manufacturer coupons, and clip-to-account discounts. Treat the visible sale/clearance price as the current buy price and NEVER subtract that markdown again as a coupon. Only additional offers with exact source evidence, confirmed exact-item applicability, valid eligibility, non-expired status, and explicit stacking may reduce net buy cost. Do not count future rewards/store cash, uncertain rebates, credit-card offers, employee discounts, first-time-only, targeted/personalized, or unknown-eligibility offers. Compare the verified net buy cost against verifiable resale prices and label fees/shipping assumptions clearly.',
        'If an arbitrage request says they want to make/earn a dollar amount this week (for example $5K), treat that amount as an AGGREGATE WEEKLY PROFIT TARGET across multiple opportunities unless they explicitly say each/per item/per deal. Never require one product to meet the whole target, and never discard smaller positive-spread opportunities merely because their combined total is still below the weekly goal.',
        ...(imageUrl
