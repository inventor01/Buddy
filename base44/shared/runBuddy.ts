...
export const FINDINGS_RULES = [
  ...
  "CRITICAL for retail arbitrage: each VERIFIED opportunity MUST include an arbitrage object with item_name, retailer, marketplace, buy_price, discount_amount, discount_description, net_buy_cost, resale_price, estimated_fees, buy_url, resale_url, and caveat. buy_url must be the exact retailer product page. resale_url must be the exact resale comp page used for the quoted price: Amazon /dp/ASIN or /gp/product/ASIN, or an exact eBay /itm/ item/listing page. Amazon/eBay search pages, sold-search result pages, category pages, result grids, retailer flyers, deals hubs, and homepages are discovery-only and NEVER sufficient evidence for a verified opportunity.",
